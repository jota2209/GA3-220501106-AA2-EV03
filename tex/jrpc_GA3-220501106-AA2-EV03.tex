...
\begin{document}
	...
	El presente documento constituye la bitácora de administración y supervisión de los servicios de Tecnologías de la Información (TI) para la empresa \textbf{Alliance Technology Group}, un BPO de Contact Center de alta exigencia operativa. En este tipo de organizaciones, la disponibilidad de los servicios, la ciberseguridad y la gestión eficiente de los incidentes son pilares fundamentales para garantizar la continuidad del negocio y el cumplimiento de los Acuerdos de Nivel de Servicio (SLA) establecidos con los diferentes clientes que contratan las campañas \parencite{sena2026redes}.
	
	Para lograr un control óptimo y mitigar los impactos negativos frente a cualquier eventualidad, el departamento de TI emplea un ecosistema robusto de herramientas tecnológicas, las cuales permiten centralizar desde la monitorización del hardware y la red hasta la gestión de identidades y la mesa de ayuda \parencite{sena2026servidores}.
	...
	\begin{itemize}
		...
		\item \textbf{Gestión de Ciberseguridad (SGSI):} Auditoría continua de bitácoras y logs, detección de vulnerabilidades e intrusiones mediante Wazuh (SIEM) y protección perimetral estricta con appliances Fortigate y Sophos.
		...
		\item \textbf{Virtualización y Contenedores:} Uso de Proxmox para virtualización y Docker para el despliegue de contenedores, lo que asegura un uso eficiente de los recursos y agilidad en el despliegue \parencite{sena2026redes}.
		\item \textbf{Control de Versiones:} Uso de Git/GitHub para la trazabilidad y gestión colaborativa del código y las configuraciones \parencite{sena2026redes}.
		\item \textbf{Gestión de Tráfico Web:} Implementación de NGINX Proxy Manager para el enrutamiento y balanceo seguro de las aplicaciones expuestas a internet.
		\end{itemize}
